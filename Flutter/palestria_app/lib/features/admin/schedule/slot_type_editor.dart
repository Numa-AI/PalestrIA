  ...
  Future<void> _save() async {
    ...
    try {
      ...
      messenger.showSnackBar(
        SnackBar(
          content: Text(
            widget.existing == null ? 'Tipo creato.' : 'Tipo aggiornato.',
          ),
        ),
      );
      navigator.pop();
    ...
    return SafeArea(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              widget.existing == null ? 'Nuovo tipo di slot' : 'Modifica tipo',
