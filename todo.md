...
- [ ] **QA freeze (DA FARE prima del merge/deploy)**: test manuale con DevTools — vedi checklist sotto. Cache bumpata: `sw.js` v532, `supabase-client.js?v=6`, `silent-refresh.js?v=3`, `data.js?v=77`, `org-settings.js?v=3`, `maintenance.js?v=2`, `app-watchdog.js?v=1`.
